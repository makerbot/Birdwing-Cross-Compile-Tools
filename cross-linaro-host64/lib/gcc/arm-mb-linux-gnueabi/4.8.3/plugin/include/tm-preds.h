/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/jh/makerbot/dev/birdwing/qt5/toolchain/cross-linaro-staging/crosstool-ng/.build/src/gcc-linaro-4.8-2014.01/gcc/config/arm/arm.md'.  */
