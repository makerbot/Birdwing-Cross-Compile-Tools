/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/jh/makerbot/dev/birdwing/qt5/toolchain/cross-linaro-staging/crosstool-ng/.build/src/gcc-linaro-4.9-2014.12/gcc/config/arm/arm.md'.  */
