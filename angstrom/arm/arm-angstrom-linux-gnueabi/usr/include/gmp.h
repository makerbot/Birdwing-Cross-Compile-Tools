...
#define __GMP_CC "arm-angstrom-linux-gnueabi-gcc -march=armv5te -mtune=arm926ej-s -mthumb-interwork -mno-thumb --sysroot=/OE/angstrom/build/tmp-angstrom_2008_1/sysroots/armv5te-angstrom-linux-gnueabi -std=gnu99"
