...
enum opt_code
{
  ...
  OPT_mdeb = 986,                            /* -mdeb */
  OPT_mint8 = 987,                           /* -mint8 */
  OPT_mlist_devices = 988,                   /* -mlist-devices */
  OPT_mlog_ = 989,                           /* -mlog= */
  OPT_mmcu_ = 990,                           /* -mmcu= */
  OPT_mno_interrupts = 991,                  /* -mno-interrupts */
  OPT_morder1 = 992,                         /* -morder1 */
  OPT_morder2 = 993,                         /* -morder2 */
  OPT_mpmem_wrap_around = 994,               /* -mpmem-wrap-around */
  OPT_mrelax = 995,                          /* -mrelax */
  OPT_mshort_calls = 996,                    /* -mshort-calls */
  OPT_msp8 = 997,                            /* -msp8 */
  OPT_mstrict_X = 998,                       /* -mstrict-X */
  OPT_mtiny_stack = 999,                     /* -mtiny-stack */
  OPT_n = 1000,                              /* -n */
  OPT_no_canonical_prefixes = 1001,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1002,              /* -no-integrated-cpp */
  OPT_nocpp = 1003,                          /* -nocpp */
  OPT_nodefaultlibs = 1004,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1005,                   /* -nostartfiles */
  OPT_nostdinc = 1006,                       /* -nostdinc */
  OPT_nostdinc__ = 1007,                     /* -nostdinc++ */
  OPT_nostdlib = 1008,                       /* -nostdlib */
  OPT_o = 1009,                              /* -o */
  OPT_p = 1010,                              /* -p */
  OPT_pass_exit_codes = 1011,                /* -pass-exit-codes */
  OPT_pedantic = 1012,                       /* -pedantic */
  OPT_pedantic_errors = 1013,                /* -pedantic-errors */
  OPT_pg = 1014,                             /* -pg */
  OPT_pie = 1015,                            /* -pie */
  OPT_pipe = 1016,                           /* -pipe */
  OPT_print_file_name_ = 1017,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1018,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1019,          /* -print-multi-directory */
  OPT_print_multi_lib = 1020,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1021,       /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 1022,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1023,               /* -print-prog-name= */
  OPT_print_search_dirs = 1024,              /* -print-search-dirs */
  OPT_print_sysroot = 1025,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1026,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1027,                          /* -quiet */
  OPT_r = 1028,                              /* -r */
  OPT_remap = 1029,                          /* -remap */
  OPT_s = 1030,                              /* -s */
  OPT_s_bc_abi = 1031,                       /* -s-bc-abi */
  OPT_save_temps = 1032,                     /* -save-temps */
  OPT_save_temps_ = 1033,                    /* -save-temps= */
  OPT_shared = 1034,                         /* -shared */
  OPT_shared_libgcc = 1035,                  /* -shared-libgcc */
  /* OPT_specs = 1036, */                    /* -specs */
  OPT_specs_ = 1037,                         /* -specs= */
  OPT_static = 1038,                         /* -static */
  OPT_static_libgcc = 1039,                  /* -static-libgcc */
  OPT_static_libgcj = 1040,                  /* -static-libgcj */
  OPT_static_libgfortran = 1041,             /* -static-libgfortran */
  OPT_static_libgo = 1042,                   /* -static-libgo */
  OPT_static_libstdc__ = 1043,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1044, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1045, */                /* -std=c++0x */
  OPT_std_c__11 = 1046,                      /* -std=c++11 */
  OPT_std_c__98 = 1047,                      /* -std=c++98 */
  OPT_std_c11 = 1048,                        /* -std=c11 */
  /* OPT_std_c1x = 1049, */                  /* -std=c1x */
  /* OPT_std_c89 = 1050, */                  /* -std=c89 */
  OPT_std_c90 = 1051,                        /* -std=c90 */
  OPT_std_c99 = 1052,                        /* -std=c99 */
  /* OPT_std_c9x = 1053, */                  /* -std=c9x */
  OPT_std_f2003 = 1054,                      /* -std=f2003 */
  OPT_std_f2008 = 1055,                      /* -std=f2008 */
  OPT_std_f2008ts = 1056,                    /* -std=f2008ts */
  OPT_std_f95 = 1057,                        /* -std=f95 */
  OPT_std_gnu = 1058,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1059, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1060, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1061,                    /* -std=gnu++11 */
  OPT_std_gnu__98 = 1062,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1063,                      /* -std=gnu11 */
  ...
  /* OPT_std_iso9899_2011 = 1073, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1074,                     /* -std=legacy */
  OPT_symbolic = 1075,                       /* -symbolic */
  OPT_t = 1076,                              /* -t */
  OPT_time = 1077,                           /* -time */
  OPT_time_ = 1078,                          /* -time= */
  OPT_traditional = 1079,                    /* -traditional */
  OPT_traditional_cpp = 1080,                /* -traditional-cpp */
  OPT_trigraphs = 1081,                      /* -trigraphs */
  OPT_u = 1082,                              /* -u */
  OPT_undef = 1083,                          /* -undef */
  OPT_v = 1084,                              /* -v */
  OPT_version = 1085,                        /* -version */
  OPT_w = 1086,                              /* -w */
  OPT_wrapper = 1087,                        /* -wrapper */
  OPT_x = 1088,                              /* -x */
  OPT_z = 1089,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
